...
namespace Week3
{
    public class SystemAdminCoordinator : ICoordinatorRepository
    {
        ...
        public bool AssignStudentToInternship(Student student, string internshipId)
        {
            ...
            // create a simple assignment object based on internship category and add to internship
            var assignment = CreateAssignmentFromCategory(internship.Category, internship.Title);
            internship.Assignments.Add(assignment);
        ...
        public bool WithdrawInternship(string internshipId)
        {
            ...
            // clear assignments for this internship
            internship.Assignments.Clear();
        ...
        public bool MarkInternshipCompleted(string internshipId, double finalGrade)
        {
            ...
            foreach (var assignment in internship.Assignments)
            {
