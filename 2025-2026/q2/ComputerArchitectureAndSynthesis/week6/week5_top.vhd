...
architecture structural of week5_top is
    ...
    signal RegWrite, ALUSrc, Branch, Zero, PCSrc, MemWrite, ResultSrc : std_logic;
...
begin
    ...
    -- 2. DECODE STAGE
    Control: entity work.Control_Unit port map(instr(6 downto 0), instr(14 downto 12), instr(31 downto 25), RegWrite, ALUSrc, Branch, MemWrite, ResultSrc, ALUControl);
    ...
    -- Result Multiplexer: Select between ALU result and memory data
