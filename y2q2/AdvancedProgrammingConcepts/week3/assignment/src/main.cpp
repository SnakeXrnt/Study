...
int main() {
    ...
    std::unique_ptr<loggers::ilogger> log = std::make_unique<logger>(std::move(writer));
    ...
    std::unique_ptr<loggers::ilogger> file_log = std::make_unique<logger>(std::move(file_writter));
