...
#ifndef lsm9ds1_I2C_SPEED
#define lsm9ds1_I2C_SPEED 400000
#endif
...
static TwoWire *g_lsm9ds1_i2c_wire = nullptr;

static imu::IIMU *g_lsm9ds1_imu = nullptr;
...
static inline void init_lsm9ds1_imu() {
    imu::lsm9ds1::config::IMUConfig imu_config;

    auto *i2c_bus = new bus::arduino::I2CBus(
        g_lsm9ds1_i2c_wire,
        static_cast<bus::arduino::I2CBus::addr_type>(
            imu::lsm9ds1::config::IMUI2CAddress::LSM9DS1_SA0_HIGH
        ),
        g_logger
    );

    g_lsm9ds1_imu = new imu::lsm9ds1::imu::I2CIMU(imu_config, i2c_bus, g_logger);
}
...
void setup() {
    ...
    Wire1.begin();
    Wire1.setClock(lsm9ds1_I2C_SPEED);

    g_lsm9ds1_i2c_wire = &Wire1;
