#ifndef INCLUDED_CLOGGER_AS_WRITER_HPP
#define INCLUDED_CLOGGER_AS_WRITER_HPP
...
namespace io::writers {
    ...
    public:
        clogger_as_writer(std::chrono::seconds interval);
...
#endif //INCLUDED_CLOGGER_AS_WRITER_HPP
